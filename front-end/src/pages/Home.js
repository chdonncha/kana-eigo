        ...
        <div className="row">
          <div className="col">
            <h1 className="text-center">
              Web application to challenge users to translate Japanese Katakana
              loan words back directly to English to improve Katakana
              proficiency and teach users how many English words that is used in
              plain sight in Japanese
            </h1>
          </div>
        </div>
      </div>
      ...
      <div className="mt-5 container">
        <div className="row align-items-center">
          ...
          <div className="col">
            ...
            quibusdam recusandae alias error harum maxime adipisci amet laborum.
            Perspiciatis minima nesciunt dolorem! Officiis iure rerum voluptates
            a cumque velit quibusdam sed amet tempora. Sit laborum ab minima
            ...
            quod quam consequuntur! Commodi minima e
          </div>
        </div>
      </div>
